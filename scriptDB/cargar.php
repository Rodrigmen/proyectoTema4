...
try {
    ...
    $sql = ("INSERT INTO Departamento(CodDepartamento,DescDepartamento, VolumenNegocio, FechaBaja) VALUES
    ...
    echo "<h3> <span style='color: green;'>" . "Tabla cargada correctamente</span></h3>"; //Si no se ha producido ningún error nos mostrará "Conexión establecida con éxito"
