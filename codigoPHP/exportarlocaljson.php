...
if (file_exists($fichero)) {
    ...
    echo '<a href="ejercicio08PDO.php">¡Crear copia de seguridad (archivo departamentosJSON.json)!</a>'; //se le muestra un enlace al usuario para ver todos los departamentos (ejercicio4)
}
?>